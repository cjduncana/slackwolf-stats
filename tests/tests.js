...
var _rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect = F3(
	function (actual, _p0, matcher) {
		return A2(_elm_lang$core$Basics$flip, matcher, actual);
	});
var _rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it = F2(
	function (description, expectation) {
		return A2(
			_elm_community$elm_test$Test$test,
			description,
			_elm_lang$core$Basics$always(expectation));
	});
var _rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$Word = {ctor: 'Word'};
var _rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to = _rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$Word;
var _rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$toBe = _rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$Word;

var _user$project$Common$toTimeString = _mgold$elm_date_format$Date_Format$format('%I:%M %p');
var _user$project$Common$toDateTimeString = _mgold$elm_date_format$Date_Format$format('%a, %b %d, %Y %I:%M %p');
var _user$project$Common$toDateString = _mgold$elm_date_format$Date_Format$format('%a, %b %d, %Y');
var _user$project$Common$isNothing = F2(
	function (x, y) {
		return _elm_lang$core$Native_Utils.eq(x, y);
	})(_elm_lang$core$Maybe$Nothing);
var _user$project$Common$isSomething = function (maybeSomething) {
	return !_user$project$Common$isNothing(maybeSomething);
};
var _user$project$Common$increaseCount = _elm_lang$core$Maybe$map(
	function (count) {
		return count + 1;
	});
var _user$project$Common$tupleHasNumber = F2(
	function (thisNumber, _p0) {
		var _p1 = _p0;
		return _elm_lang$core$Native_Utils.eq(thisNumber, _p1._1);
	});
var _user$project$Common$hasMost = function (count) {
	var counts = _elm_lang$core$Dict$values(count);
	var highestCount = A2(
		_elm_lang$core$Maybe$withDefault,
		0,
		_elm_lang$core$List$maximum(counts));
	var hasHighestCount = _user$project$Common$tupleHasNumber(highestCount);
	return A2(
		_elm_lang$core$List$map,
		...
		A2(
			...
			hasHighestCount,
			_elm_lang$core$Dict$toList(count)));
};
var _user$project$Common$countingIndex = function (index) {
	return _elm_lang$core$Basics$toString(index + 1);
};

var _user$project$Models_Player$countPlayer = F2(
	function (_p0, count) {
		var _p1 = _p0;
		var _p2 = _p1.id;
		return A2(_elm_lang$core$Dict$member, _p2, count) ? A3(_elm_lang$core$Dict$update, _p2, _user$project$Common$increaseCount, count) : A3(_elm_lang$core$Dict$insert, _p2, 1, count);
	});
var _user$project$Models_Player$countPlayers = function (players) {
	return A3(_elm_lang$core$List$foldl, _user$project$Models_Player$countPlayer, _elm_lang$core$Dict$empty, players);
};
var _user$project$Models_Player$toRoleString = function (role) {
	var _p3 = role;
	switch (_p3.ctor) {
		case 'Seer':
			return 'Seer';
...
var _user$project$Models_Player$PlayerModel = F4(
	function (a, b, c, d) {
		return {id: a, username: b, role: c, death: d};
	});
var _user$project$Models_Player$Unknown = {ctor: 'Unknown'};
var _user$project$Models_Player$Tanner = {ctor: 'Tanner'};
var _user$project$Models_Player$Sorceress = {ctor: 'Sorceress'};
var _user$project$Models_Player$Wolfman = {ctor: 'Wolfman'};
var _user$project$Models_Player$Lycan = {ctor: 'Lycan'};
var _user$project$Models_Player$Bodyguard = {ctor: 'Bodyguard'};
var _user$project$Models_Player$Beholder = {ctor: 'Beholder'};
var _user$project$Models_Player$Villager = {ctor: 'Villager'};
var _user$project$Models_Player$Werewolf = {ctor: 'Werewolf'};
var _user$project$Models_Player$Hunter = {ctor: 'Hunter'};
var _user$project$Models_Player$Witch = {ctor: 'Witch'};
var _user$project$Models_Player$Seer = {ctor: 'Seer'};

var _user$project$Models_Action$toObjectString = function (maybeObject) {
	var _p0 = maybeObject;
	if (_p0.ctor === 'Just') {
		return _p0._0.username;
	} else {
		return 'noone';
	}
};
var _user$project$Models_Action$toVerbString = function (verb) {
	var _p1 = verb;
	switch (_p1.ctor) {
		case 'See':
			return 'sees';
...
var _user$project$Models_Action$toActionString = function (_p2) {
	var _p3 = _p2;
	return A2(
		_elm_lang$core$String$join,
		' ',
		{
			ctor: '::',
			_0: _p3.subject.username,
			_1: {
				ctor: '::',
				_0: _user$project$Models_Action$toVerbString(_p3.verb),
				_1: {
					ctor: '::',
					_0: _user$project$Models_Action$toObjectString(_p3.object),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$Models_Action$mostFrequentObjects = function (actions) {
	var getObjects = F2(
		function (_p4, previousObjects) {
			var _p5 = _p4;
			var _p6 = _p5.object;
			if (_p6.ctor === 'Nothing') {
	...
	var objects = A3(
		...
		{ctor: '[]'},
		actions);
	var idToObjects = function (id) {
		return A2(
			_elm_lang$core$List$filter,
			function (object) {
				return _elm_lang$core$Native_Utils.eq(object.id, id);
			},
			objects);
	};
	var idToObject = F2(
		function (id, previousObjects) {
			return A2(
				_elm_lang$core$Basics_ops['++'],
				previousObjects,
				idToObjects(id));
	...
	return A3(
		...
		idToObject,
		{ctor: '[]'},
		_user$project$Common$hasMost(
			_user$project$Models_Player$countPlayers(objects)));
};
var _user$project$Models_Action$hasObject = function (_p7) {
	var _p8 = _p7;
	return _user$project$Common$isSomething(_p8.object);
};
var _user$project$Models_Action$ActionModel = F4(
	function (a, b, c, d) {
		return {id: a, subject: b, verb: c, object: d};
	});
var _user$project$Models_Action$Vote = {ctor: 'Vote'};
var _user$project$Models_Action$voted = function (_p9) {
	var _p10 = _p9;
	return _elm_lang$core$Native_Utils.eq(_p10.verb, _user$project$Models_Action$Vote);
};
var _user$project$Models_Action$votedForSomeOne = function (action) {
	return _user$project$Models_Action$voted(action) && _user$project$Models_Action$hasObject(action);
};
var _user$project$Models_Action$withVotes = _elm_lang$core$List$filter(_user$project$Models_Action$votedForSomeOne);
var _user$project$Models_Action$lynchedUsername = function (actions) {
	var possiblyLynched = _user$project$Models_Action$mostFrequentObjects(
		_user$project$Models_Action$withVotes(actions));
	return _elm_lang$core$Native_Utils.eq(
		_elm_lang$core$List$length(possiblyLynched),
		1) ? A2(
		_elm_lang$core$Maybe$withDefault,
		'No one was lynched',
		A2(
			...
			_elm_lang$core$List$head(possiblyLynched))) : 'No one was lynched';
};
var _user$project$Models_Action$Kill = {ctor: 'Kill'};
var _user$project$Models_Action$Poison = {ctor: 'Poison'};
var _user$project$Models_Action$Heal = {ctor: 'Heal'};
var _user$project$Models_Action$See = {ctor: 'See'};
var _user$project$Models_Action$Unknown = {ctor: 'Unknown'};

var _user$project$Routing_Routes$gameParser = A2(
	_evancz$url_parser$UrlParser_ops['</>'],
	_evancz$url_parser$UrlParser$s('games'),
	_evancz$url_parser$UrlParser$string);
var _user$project$Routing_Routes$homeParser = _evancz$url_parser$UrlParser$s('');
var _user$project$Routing_Routes$baseHash = '/#/';
var _user$project$Routing_Routes$encode = function (route) {
	var _p0 = route;
	switch (_p0.ctor) {
		case 'HomeRoute':
			return _user$project$Routing_Routes$baseHash;
		case 'GameRoute':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$Routing_Routes$baseHash,
				A2(_elm_lang$core$Basics_ops['++'], 'games/', _p0._0));
		default:
			return _user$project$Routing_Routes$baseHash;
	}
};
var _user$project$Routing_Routes$NoRoute = {ctor: 'NoRoute'};
var _user$project$Routing_Routes$GameRoute = function (a) {
	return {ctor: 'GameRoute', _0: a};
};
var _user$project$Routing_Routes$HomeRoute = {ctor: 'HomeRoute'};
var _user$project$Routing_Routes$routeParser = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Routing_Routes$HomeRoute, _user$project$Routing_Routes$homeParser),
		_1: {
			ctor: '::',
			_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Routing_Routes$GameRoute, _user$project$Routing_Routes$gameParser),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Routing_Routes$decode = function (location) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$Routing_Routes$NoRoute,
		A2(_evancz$url_parser$UrlParser$parseHash, _user$project$Routing_Routes$routeParser, location));
};

var _user$project$Tests_Common$date = function () {
	var timeIntoDate = _elm_lang$core$Date$fromTime(_elm_lang$core$Time$hour);
	var dateResult = _elm_lang$core$Date$fromString('2016-12-25T05:30:30-06:00');
	var _p0 = dateResult;
	if (_p0.ctor === 'Ok') {
		return _p0._0;
	} else {
...
var _user$project$Tests_Common$threeWinners = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: '540448bb-163c-40b1-9deb-2c8c27e67f3f', _1: 7},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'd9532423-8fc8-446f-a879-b213a462a237', _1: 3},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: '773aa956-d8bf-47e2-815b-ecde6331400b', _1: 4},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: '41b78dd9-153c-482e-bcab-5fe6d6e97d29', _1: 7},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'df079ce7-873f-4913-ae4c-eec5cc03ba41', _1: 8},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'e9e25ff9-3d60-4a3a-a599-acfb2163882a', _1: 8},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: '2045d406-6e42-4b47-bf2a-b89ac2db83f4', _1: 8},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: '74b8b904-9116-41ca-ac1f-43d207b7d49f', _1: 1},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: '1e2f91e3-6e46-4aac-adcf-fb1e1c082889', _1: 4},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'b050508f-39d2-41a3-aeab-c76c51c5642d', _1: 5},
											_1: {ctor: '[]'}
										}
									}
								}
...
var _user$project$Tests_Common$oneWinner = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: '540448bb-163c-40b1-9deb-2c8c27e67f3f', _1: 7},
		_1: {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'e9e25ff9-3d60-4a3a-a599-acfb2163882a', _1: 9},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: '2045d406-6e42-4b47-bf2a-b89ac2db83f4', _1: 8},
								_1: {
...
var _user$project$Tests_Common$hundredTests = _elm_community$elm_test$Test$fuzzWith(
	{runs: 100});
var _user$project$Tests_Common$testThreeIntegers = _user$project$Tests_Common$hundredTests(
	_elm_community$elm_test$Fuzz$tuple3(
		{ctor: '_Tuple3', _0: _elm_community$elm_test$Fuzz$int, _1: _elm_community$elm_test$Fuzz$int, _2: _elm_community$elm_test$Fuzz$int}));
var _user$project$Tests_Common$testMaybeInteger = _user$project$Tests_Common$hundredTests(
	_elm_community$elm_test$Fuzz$maybe(_elm_community$elm_test$Fuzz$int));
var _user$project$Tests_Common$testInteger = _user$project$Tests_Common$hundredTests(_elm_community$elm_test$Fuzz$int);
var _user$project$Tests_Common$all = A2(
	...
	'Common',
	{
		...
		_0: A2(
			...
			'countingIndex',
			{
				ctor: '::',
				_0: A2(
					_user$project$Tests_Common$testInteger,
					'should produce the string value of the increment',
					function ($int) {
						return A4(
							_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
							_elm_lang$core$String$toInt(
								_user$project$Common$countingIndex($int)),
							_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
							_elm_community$elm_test$Expect$equal,
							_elm_lang$core$Result$Ok($int + 1));
					}),
				_1: {ctor: '[]'}
			}),
		_1: {
			...
			_0: A2(
				...
				'hasMost',
				{
					...
					_0: A2(
						...
						'should return a list with one ID if that ID has the largest number',
						A4(
							_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
							_user$project$Common$hasMost(_user$project$Tests_Common$oneWinner),
							_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
							_elm_community$elm_test$Expect$equal,
							{
								ctor: '::',
								_0: 'e9e25ff9-3d60-4a3a-a599-acfb2163882a',
								_1: {ctor: '[]'}
							})),
					_1: {
						ctor: '::',
						_0: A2(
							_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
							'should return a list with three IDs if those IDs have the largest number',
							A4(
								_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
								_user$project$Common$hasMost(_user$project$Tests_Common$threeWinners),
								_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
								_elm_community$elm_test$Expect$equal,
								{
									ctor: '::',
									_0: '2045d406-6e42-4b47-bf2a-b89ac2db83f4',
									_1: {
										ctor: '::',
										_0: 'df079ce7-873f-4913-ae4c-eec5cc03ba41',
										_1: {
											ctor: '::',
											_0: 'e9e25ff9-3d60-4a3a-a599-acfb2163882a',
											_1: {ctor: '[]'}
						...
						_1: {
							...
							_0: A2(
								_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
								'should return an empty list if an empty Dict is provided',
								A4(
									_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
									_user$project$Common$hasMost(_elm_lang$core$Dict$empty),
									_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
									_elm_community$elm_test$Expect$equal,
									{ctor: '[]'})),
							_1: {ctor: '[]'}
			...
			_1: {
				...
				_0: A2(
					...
					'tupleHasNumber',
					{
						ctor: '::',
						_0: A2(
							_user$project$Tests_Common$testThreeIntegers,
							'should return the same equality if the first integer matches the third one',
							function (_p1) {
								var _p2 = _p1;
								var _p4 = _p2._2;
								var _p3 = _p2._0;
								return A4(
									_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
									A2(
										_user$project$Common$tupleHasNumber,
										_p3,
										{ctor: '_Tuple2', _0: _p2._1, _1: _p4}),
									_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
									_elm_community$elm_test$Expect$equal,
									_elm_lang$core$Native_Utils.eq(_p3, _p4));
							}),
						_1: {ctor: '[]'}
					}),
				_1: {
					...
					_0: A2(
						...
						'increaseCount',
						{
							ctor: '::',
							_0: A2(
								_user$project$Tests_Common$testMaybeInteger,
								'should return just the value of the increment',
								function (maybeInt) {
									return A4(
										_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
										A2(
											...
											_user$project$Common$increaseCount(maybeInt)),
										_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
										_elm_community$elm_test$Expect$equal,
										maybeInt);
								}),
					...
					_1: {
						...
						_0: A2(
							...
							'isNothing',
							{
								...
								_0: A2(
									_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
									'should return True if Nothing is given',
									A4(
										_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
										_user$project$Common$isNothing(_elm_lang$core$Maybe$Nothing),
										_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
										_elm_community$elm_test$Expect$equal,
										true)),
								_1: {
									...
									_0: A2(
										_user$project$Tests_Common$testInteger,
										'should return False if anything but Nothing is given',
										function ($int) {
											return A4(
												_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
												_user$project$Common$isNothing(
													_elm_lang$core$Maybe$Just($int)),
												_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
												_elm_community$elm_test$Expect$equal,
												false);
										}),
						...
						_1: {
							...
							_0: A2(
								...
								'isSomething',
								{
									...
									_0: A2(
										_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
										'should return False if Nothing is given',
										A4(
											_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
											_user$project$Common$isSomething(_elm_lang$core$Maybe$Nothing),
											_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
											_elm_community$elm_test$Expect$equal,
											false)),
									_1: {
										...
										_0: A2(
											_user$project$Tests_Common$testInteger,
											'should return True if anything but Nothing is given',
											function ($int) {
												return A4(
													_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
													_user$project$Common$isSomething(
														_elm_lang$core$Maybe$Just($int)),
													_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
													_elm_community$elm_test$Expect$equal,
													true);
							...
							_1: {
								...
								_0: A2(
									...
									'toDateString',
									{
										...
										_0: A2(
											_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
											'should return a formatted String of the provided Date',
											A4(
												_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
												_user$project$Common$toDateString(_user$project$Tests_Common$date),
												_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
												_elm_community$elm_test$Expect$equal,
												'Sun, Dec 25, 2016')),
										_1: {ctor: '[]'}
								...
								_1: {
									...
									_0: A2(
										...
										'toDateTimeString',
										{
											...
											_0: A2(
												_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
												'should return a formatted String of the provided Date and Time',
												A4(
													_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
													_user$project$Common$toDateTimeString(_user$project$Tests_Common$date),
													_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
													_elm_community$elm_test$Expect$equal,
													'Sun, Dec 25, 2016 05:30 AM')),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											'toTimeString',
											{
												...
												_0: A2(
													_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
													'should return a formatted String of the provided Time',
													A4(
														_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
														_user$project$Common$toTimeString(_user$project$Tests_Common$date),
														_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
														_elm_community$elm_test$Expect$equal,
														'05:30 AM')),
												_1: {ctor: '[]'}
...
var _user$project$Tests_Models_Action$firstDay = {
	ctor: '::',
	_0: {
		id: '60790525-2d63-4c98-b922-49efe8197d42',
		subject: {id: 'bc6b193e-a0e7-428e-940b-ba3b23420c5b', username: '@cristiano.amici', role: _user$project$Models_Player$Hunter, death: _elm_lang$core$Maybe$Nothing},
		verb: _user$project$Models_Action$Vote,
		object: _elm_lang$core$Maybe$Just(
			{
				id: '207aca14-04c3-4e03-8091-9a4f8f65c337',
				username: '@alvaro',
				role: _user$project$Models_Player$Villager,
				death: _elm_lang$core$Maybe$Just('f15c38b2-5adc-464c-94cc-521821284d5e')
			})
	},
	_1: {
		ctor: '::',
		_0: {
			...
			subject: {id: '96f1ddcf-e56f-4055-9755-e6466f49f667', username: '@figueroa', role: _user$project$Models_Player$Witch, death: _elm_lang$core$Maybe$Nothing},
			verb: _user$project$Models_Action$Vote,
			object: _elm_lang$core$Maybe$Nothing
		},
		_1: {ctor: '[]'}
	}
};
var _user$project$Tests_Models_Action$sampleAction = {
	id: '5170ca11-f5b7-4b92-b29c-e9b0b81f2dce',
	subject: {id: '5af0ddd3-c656-4920-bd29-d7e0dba3fb8c', username: '@john.doe', role: _user$project$Models_Player$Seer, death: _elm_lang$core$Maybe$Nothing},
	verb: _user$project$Models_Action$Vote,
	object: _elm_lang$core$Maybe$Nothing
};
var _user$project$Tests_Models_Action$sampleActionWithObject = function () {
	var object_ = {id: 'e68c151c-85a1-4d12-af33-2587eae4f865', username: '@jane.doe', role: _user$project$Models_Player$Werewolf, death: _elm_lang$core$Maybe$Nothing};
	return _elm_lang$core$Native_Utils.update(
		_user$project$Tests_Models_Action$sampleAction,
		{
			object: _elm_lang$core$Maybe$Just(object_)
		});
}();
var _user$project$Tests_Models_Action$all = A2(
	_elm_community$elm_test$Test$describe,
	'Action Model',
	{
		ctor: '::',
		_0: A2(
			...
			'lynchedUsername',
			{
				...
				_0: A2(
					_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
					'should say noone was lynched if all of the votes were for noone',
					A4(
						_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
						_user$project$Models_Action$lynchedUsername(
							{
								ctor: '::',
								_0: _user$project$Tests_Models_Action$sampleAction,
								_1: {ctor: '[]'}
							}),
						_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
						_elm_community$elm_test$Expect$equal,
				...
				_1: {
					...
					_0: A2(
						_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
						'should say that @jane.doe was lynched if she\'s recieved the most votes',
						A4(
							_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
							_user$project$Models_Action$lynchedUsername(
								{
									ctor: '::',
									_0: _user$project$Tests_Models_Action$sampleActionWithObject,
									_1: {ctor: '[]'}
								}),
							_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
							_elm_community$elm_test$Expect$equal,
					...
					_1: {
						...
						_0: A2(
							_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
							'should say that @alvaro was lynched',
							A4(
								_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
								_user$project$Models_Action$lynchedUsername(_user$project$Tests_Models_Action$firstDay),
								_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
								_elm_community$elm_test$Expect$equal,
								'@alvaro')),
						_1: {ctor: '[]'}
		...
		_1: {
			...
			_0: A2(
				...
				'toActionString',
				{
					...
					_0: A2(
						_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
						'should return the action performed as a String',
						A4(
							_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
							_user$project$Models_Action$toActionString(_user$project$Tests_Models_Action$sampleAction),
							_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
							_elm_community$elm_test$Expect$equal,
...
var _user$project$Tests_Models_Player$samplePlayer = {id: 'b1f50648-f759-4e31-a061-ce9dd947de3c', username: '@john.doe', role: _user$project$Models_Player$Seer, death: _elm_lang$core$Maybe$Nothing};
var _user$project$Tests_Models_Player$all = A2(
	_elm_community$elm_test$Test$describe,
	'Player Model',
	{
		ctor: '::',
		_0: A2(
			...
			'countPlayers',
			{
				...
				_0: A2(
					_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
					'should return a Dict with one item in it',
					A4(
						_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
						_user$project$Models_Player$countPlayers(
							{
								ctor: '::',
								_0: _user$project$Tests_Models_Player$samplePlayer,
								_1: {
									ctor: '::',
									_0: _user$project$Tests_Models_Player$samplePlayer,
									_1: {ctor: '[]'}
						...
						_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
						_elm_community$elm_test$Expect$equal,
						A2(_elm_lang$core$Dict$singleton, 'b1f50648-f759-4e31-a061-ce9dd947de3c', 2))),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				...
				'toRoleString',
				{
					...
					_0: A2(
						_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
						'should return Seer when a Seer is provided',
						A4(
							_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
							_user$project$Models_Player$toRoleString(_user$project$Models_Player$Seer),
							_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
							_elm_community$elm_test$Expect$equal,
							'Seer')),
					_1: {
						...
						_0: A2(
							_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
							'should return Witch when a Witch is provided',
							A4(
								_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
								_user$project$Models_Player$toRoleString(_user$project$Models_Player$Witch),
								_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
								_elm_community$elm_test$Expect$equal,
								'Witch')),
						_1: {
							...
							_0: A2(
								_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
								'should return Hunter when a Hunter is provided',
								A4(
									_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
									_user$project$Models_Player$toRoleString(_user$project$Models_Player$Hunter),
									_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
									_elm_community$elm_test$Expect$equal,
									'Hunter')),
							_1: {
								...
								_0: A2(
									_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
									'should return Werewolf when a Werewolf is provided',
									A4(
										_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
										_user$project$Models_Player$toRoleString(_user$project$Models_Player$Werewolf),
										_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
										_elm_community$elm_test$Expect$equal,
										'Werewolf')),
								_1: {
									...
									_0: A2(
										_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
										'should return Villager when a Villager is provided',
										A4(
											_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
											_user$project$Models_Player$toRoleString(_user$project$Models_Player$Villager),
											_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
											_elm_community$elm_test$Expect$equal,
											'Villager')),
									_1: {
										...
										_0: A2(
											_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
											'should return Beholder when a Beholder is provided',
											A4(
												_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
												_user$project$Models_Player$toRoleString(_user$project$Models_Player$Beholder),
												_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
												_elm_community$elm_test$Expect$equal,
												'Beholder')),
										_1: {
											...
											_0: A2(
												_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
												'should return Bodyguard when a Bodyguard is provided',
												A4(
													_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
													_user$project$Models_Player$toRoleString(_user$project$Models_Player$Bodyguard),
													_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
													_elm_community$elm_test$Expect$equal,
													'Bodyguard')),
											_1: {
												...
												_0: A2(
													_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
													'should return Lycan when a Lycan is provided',
													A4(
														_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
														_user$project$Models_Player$toRoleString(_user$project$Models_Player$Lycan),
														_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
														_elm_community$elm_test$Expect$equal,
														'Lycan')),
												_1: {
													...
													_0: A2(
														_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
														'should return Wolfman when a Wolfman is provided',
														A4(
															_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
															_user$project$Models_Player$toRoleString(_user$project$Models_Player$Wolfman),
															_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
															_elm_community$elm_test$Expect$equal,
															'Wolfman')),
													_1: {
														...
														_0: A2(
															_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
															'should return Sorceress when a Sorceress is provided',
															A4(
																_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
																_user$project$Models_Player$toRoleString(_user$project$Models_Player$Sorceress),
																_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
																_elm_community$elm_test$Expect$equal,
																'Sorceress')),
														_1: {
															...
															_0: A2(
																_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
																'should return Tanner when a Tanner is provided',
																A4(
																	_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
																	_user$project$Models_Player$toRoleString(_user$project$Models_Player$Tanner),
																	_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
																	_elm_community$elm_test$Expect$equal,
																	'Tanner')),
															_1: {ctor: '[]'}
...
var _user$project$Tests_Routing_Routes$emptyLocation = _elm_lang$navigation$Navigation$Location('')('')('')('')('')('')('')('')('#/')('')('');
var _user$project$Tests_Routing_Routes$wrongLocation = _elm_lang$core$Native_Utils.update(
	_user$project$Tests_Routing_Routes$emptyLocation,
	{hash: '#/wrong-path'});
var _user$project$Tests_Routing_Routes$gameLocation = _elm_lang$core$Native_Utils.update(
	_user$project$Tests_Routing_Routes$emptyLocation,
	{hash: '#/games/5eba0d06-a83c-44f0-925c-6ef9671385a2'});
var _user$project$Tests_Routing_Routes$all = A2(
	_elm_community$elm_test$Test$describe,
	'Routes',
	{
		ctor: '::',
		_0: A2(
			...
			'decode',
			{
				...
				_0: A2(
					_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
					'should return No Route if there was no matching path',
					A4(
						_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
						_user$project$Routing_Routes$decode(_user$project$Tests_Routing_Routes$wrongLocation),
						_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
						_elm_community$elm_test$Expect$equal,
						_user$project$Routing_Routes$NoRoute)),
				_1: {
					...
					_0: A2(
						_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
						'should return the Home Route if an empty path is provided',
						A4(
							_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
							_user$project$Routing_Routes$decode(_user$project$Tests_Routing_Routes$emptyLocation),
							_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
							_elm_community$elm_test$Expect$equal,
							_user$project$Routing_Routes$HomeRoute)),
					_1: {
						ctor: '::',
						_0: A2(
							_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
							'should return the Game Route if \'/games/a-uuid\' in path is provided',
							A4(
								_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
								_user$project$Routing_Routes$decode(_user$project$Tests_Routing_Routes$gameLocation),
								_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
								_elm_community$elm_test$Expect$equal,
								_user$project$Routing_Routes$GameRoute('5eba0d06-a83c-44f0-925c-6ef9671385a2'))),
						_1: {ctor: '[]'}
					}
				}
			}),
		_1: {
			...
			_0: A2(
				...
				'encode',
				{
					...
					_0: A2(
						_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
						'should return the Home URL if the the Home Route is provided',
						A4(
							_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
							_user$project$Routing_Routes$encode(_user$project$Routing_Routes$HomeRoute),
							_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
							_elm_community$elm_test$Expect$equal,
							'/#/')),
					_1: {
						...
						_0: A2(
							_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
							'should return the Game URL with the Game UUID if the Game Route is provided with that Game UUID',
							A4(
								_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
								_user$project$Routing_Routes$encode(
									_user$project$Routing_Routes$GameRoute('48caf33c-7413-4681-a017-eabefb969a75')),
								_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
								_elm_community$elm_test$Expect$equal,
								'/#/games/48caf33c-7413-4681-a017-eabefb969a75')),
						_1: {
							ctor: '::',
							_0: A2(
								_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$it,
								'should return the Home URL if No Route is provided',
								A4(
									_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$expect,
									_user$project$Routing_Routes$encode(_user$project$Routing_Routes$NoRoute),
									_rogeriochaves$elm_test_bdd_style$ElmTestBDDStyle$to,
									_elm_community$elm_test$Expect$equal,
									'/#/')),
							_1: {ctor: '[]'}
...
var _user$project$Tests$all = A2(
	...
	{
		ctor: '::',
		_0: _user$project$Tests_Common$all,
		_1: {
			ctor: '::',
			_0: _user$project$Tests_Models_Action$all,
			_1: {
				ctor: '::',
				_0: _user$project$Tests_Models_Player$all,
				_1: {
					ctor: '::',
					_0: _user$project$Tests_Routing_Routes$all,
					_1: {ctor: '[]'}
				}
			}
		}
...
var Elm = {};
Elm['Tests'] = Elm['Tests'] || {};
if (typeof _user$project$Tests$main !== 'undefined') {
    _user$project$Tests$main(Elm['Tests'], 'Tests', undefined);
}
